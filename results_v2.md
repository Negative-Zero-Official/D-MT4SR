...
```
PS C:\Users\pgait\Documents\Coding Projects and Repos\D-MT4SR> python aggregate_results.py appliances_main/ --metric MRR --paired --baseline "SASRecModel-Appliances"                                               
...
==============================================================================
PAIRED vs BASELINE  |  dataset: Appliances  |  metric: MRR
baseline: SASRecModel-Appliances-128-1-1-gelu-0.1-0.3-100-0.001-0.0-0.1-0.05-10
==============================================================================
(common prefix omitted from labels: 128-1-1-gelu-0.1-0.3-100-0.001-0.0-0.1-0.05-)
config                                                     n    W-L     mean d     rel%    p(t)  p(sgn)  per-seed deltas
------------------------------------------------------------------------------------------------------------------------
10-timedecayFalse-realtimesTrue-dynlossFalse-popnegFalse  10  10-0     +0.0200   +72.3%   0.000   0.002  +0.0214 +0.0170 +0.0209 +0.0182 +0.0215 +0.0177 +0.0216 +0.0212 +0.0190 +0.0218
10                                                        10  10-0     +0.0174   +62.8%   0.000   0.002  +0.0117 +0.0181 +0.0183 +0.0171 +0.0194 +0.0179 +0.0204 +0.0137 +0.0161 +0.0211
...
Reading this table:
  ...
  At n=3 nothing here clears p<0.05 unless the effect is large AND very
  consistent. Run 5-10 seeds on whichever configs you intend to claim.
PS C:\Users\pgait\Documents\Coding Projects and Repos\D-MT4SR> python aggregate_results.py appliances_main/ --metric NDCG@10 --paired --baseline "SASRecModel-Appliances"
...
config                                                     n    W-L     mean d     rel%    p(t)  p(sgn)  per-seed deltas
------------------------------------------------------------------------------------------------------------------------
10-timedecayFalse-realtimesTrue-dynlossFalse-popnegFalse  10  10-0     +0.0267   +85.4%   0.000   0.002  +0.0284 +0.0256 +0.0264 +0.0256 +0.0262 +0.0243 +0.0303 +0.0265 +0.0258 +0.0278
10                                                        10  10-0     +0.0231   +73.9%   0.000   0.002  +0.0188 +0.0249 +0.0244 +0.0232 +0.0255 +0.0236 +0.0294 +0.0175 +0.0200 +0.0237
...
Reading this table:
  ...
  At n=3 nothing here clears p<0.05 unless the effect is large AND very
  consistent. Run 5-10 seeds on whichever configs you intend to claim.
PS C:\Users\pgait\Documents\Coding Projects and Repos\D-MT4SR> python aggregate_results.py appliances_main/ --metric HIT@10 --paired --baseline "SASRecModel-Appliances" 
...
config                                                     n    W-L     mean d     rel%    p(t)  p(sgn)  per-seed deltas
------------------------------------------------------------------------------------------------------------------------
10-timedecayFalse-realtimesTrue-dynlossFalse-popnegFalse  10  10-0     +0.0550  +112.2%   0.000   0.002  +0.0584 +0.0571 +0.0526 +0.0564 +0.0494 +0.0532 +0.0629 +0.0513 +0.0539 +0.0552
10                                                        10  10-0     +0.0484   +98.6%   0.000   0.002  +0.0487 +0.0526 +0.0526 +0.0487 +0.0539 +0.0475 +0.0616 +0.0391 +0.0391 +0.0398
